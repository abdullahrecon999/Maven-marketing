...
const BusinessDashboard = ({data, data2}) => {
  ...
  return (
    <div className='flex  flex-col pl-16 py-6 md:pl-0 w-[100%]'>
          ...
          <h1 onClick={() => {logout()}} className='font-railway text-grey text-sm'>Dashboard</h1>
            <div className='flex'>
              <div >
          ...
          {show && <CampaignComponent data={data} ></CampaignComponent>}
          {!show && <InfluencerTable data={data2}></InfluencerTable>}
