...
const BidModal = ({ data, brand, id, influencer, onClose }) => {
	...
	const handleSubmit = async (values) => {
		...
		console.log("URL:",url)
		console.log(val," ",url)
		return await axios.post(`http://localhost:3000/influencer/bidCampaign/${id}`, val, {
			headers: {
							...
							<div className='w-[70%] h-full  bg-white p-4 border rounded-xl overflow-y-auto '>
								<div className="space-y-2">
									...
									<div className='space-y-1'>
										...
										<textarea rows="4" class="block p-2.5 w-full text-sm  bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Add your cover letter here" required onChange={(e) => {
