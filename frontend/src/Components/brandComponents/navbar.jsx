                  ...
                  <div className="flex gap-2 flex-wrap">
                    <a href="#">
                      <div className="flex py-1 px-2 rounded-full border hover:shadow-lg text-sm items-center pr-3">
                        <img className="w-8 h-auto p-2" src="https://www.vectorlogo.zone/logos/instagram/instagram-icon.svg" />
                        <p>Instagram</p>
                      </div>
                    </a>
                    <a href="#">
                      <div className="flex py-1 px-2 rounded-full border hover:shadow-lg text-sm items-center pr-3">
                        <img className="w-8 h-auto p-2" src="https://www.vectorlogo.zone/logos/twitter/twitter-official.svg" />
                        <p>Twitter</p>
                      </div>
                    </a>
                    <a href="#">
                      <div className="flex py-1 px-2 rounded-full border hover:shadow-lg text-sm items-center pr-3">
                        <img className="w-8 h-auto p-2" src="https://www.vectorlogo.zone/logos/youtube/youtube-icon.svg" />
                        <p>Youtube</p>
                      </div>
                    </a>
                    <a href="#">
                      <div className="flex py-1 px-2 rounded-full border hover:shadow-lg text-sm items-center pr-3">
                        <img className="w-8 h-auto p-2" src="https://www.vectorlogo.zone/logos/snapchat/snapchat-icon.svg" />
                        <p>Snapchat</p>
                      </div>
                    </a>
                  </div>
