...
const Contract= ({text, id}) => {
  ...
  return (
    <div className='flex  p-4 border bg-white rounded-md shadow-xl'>
             <div className="flex flex-col justify-center  w-[100%] ">
              <h1 className='text-base text-black font-railway self px-2 mb-3'>Contract</h1>
                <div className="space-y-3 border-2 px-4 py-3 w-[100%] bg-slate-50 rounded-md">
                 ...
                 }} className='bg-green text-center text-white font-railway rounded-full px-3 py-2 hover:bg-grey'>View</button>
