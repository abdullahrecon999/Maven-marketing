  ...
  const handleDelete = (referenceUrl, name) => {
    if (window.confirm("Are you sure to delete file name")) {
      ...
      deleteObject(
        ref(
          storage,
          "gs://mavenmarketing-93029.appspot.com/ODgyXzE2Nzk1MDQyMDcxNDZfNDk/brand (1).jpg"
        )
      )
        .then(async () => {
          alert("file removed");
      ...
      {true ? (
        ...
        <div className="flex flex-col space-y-3">
          <div className="border bg-white p-3 h-[40vh] ">
            ...
            <div className="flex justify-between items-center px-3 py-2 border-b-2">
              <div className="space-x-0">
                <h1 className="text-sm text-gray-800 font-railway">
                  File name
                </h1>
                <h1 className="mt-0 text-xs text-gray-500 italic">
                  uploaded at date and time
                </h1>
              </div>
              <div className="dropdown dropdown-end">
                ...
                <ul
                  tabIndex={0}
                  className="dropdown-content menu p-2 bg-base-100 rounded-box w-24 border shadow-md"
                >
                  ...
                  <li
                    ...
                    onClick={() => {
                      handleDelete(
                        "https://firebasestorage.googleapis.com/v0/b/mavenmarketing-93029.appspot.com/o/ODgyXzE2Nzk1MDQyMDcxNDZfNDk%2Fbrand%20(1).jpg?alt=media&token=d95166ee-0c69-42c6-8d0e-3e7e72ca85be",
                        "brand (1).jpg"
                      );
                    }}
                  >
          ...
          <div className="self-end">
            {type === "brand" ? null : (
              <>
                <Button htmlFor="File">Upload more files</Button>
                <input
                  id="File"
                  onChange={(e) => {
                    upload(e.currentTarget.files[0]);
