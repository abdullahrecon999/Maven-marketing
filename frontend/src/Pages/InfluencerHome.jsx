...
const InfluencerHome = () => {
  ...
  const {data, isLoading, isError, isSuccess} = useQuery(["getLimitedCampaigns"],()=>{
      ...
      <div className="flex flex-col flex-1 container mx-12  ">
            ...
            <div className="card w-72 h-40 bg-base-100 shadow-xl rounded-xl" data-theme="corporate">
              <div className="card-body flex-row p-5">
                <div className="flex-col w-40">
                  ...
                  <p className="py-2 text-sm">Your available payouts are displayed here</p>
        ...
        <div className="flex justify-between py-5 min-w-xl">
          <div className="flex-col card-body p-4 rounded-lg h-auto bg-base-100 w-full" data-theme="corporate">
            ...
            {data !== "undefined"?<div className="flex w-full h-[450px]">
            ...
            </div>:<div className='flex flex-full justify-center items-center h-[450px]' data-theme="corporate">
