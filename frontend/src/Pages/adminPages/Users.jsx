...
const getData = async () => {
  return await await axios
    .get("http://localhost:3000/influencer/all", { withCredentials: true })
    .then((res) => {
...
const Users = () => {
  ...
  useEffect(() => {
    ...
    const fetchUserAuth = async () => {
      ...
      setLoading(true);
      await axios
        .get("http://localhost:3000/admin/getInfluencers", {
    ...
    <div>
      ...
      <div className="flex border shadow-inner">
        ...
        <div className="flex flex-col items-center px-14 pt-7 ">
          <div className=" ">
            <h1 className=" text-gray-800 font-medium text-xl pr-3">
              Influencers
            </h1>
            <p className="text-base  pr-3 text-grey">
              list of all the verfied influencers
            </p>
            <div className="w-[900px]">
              {/* {data ? (
                    <div className='flex justify-center items-center'>
                      <h1 className=' text-blue text-base'>Loading...</h1>
                    </div>
                  ) : (
                    <UsersTable data={data} type = "influencer"></UsersTable>
                  )} */}

              <div className="w-[900px] h-[80vh] border ">
                {loading ? (
