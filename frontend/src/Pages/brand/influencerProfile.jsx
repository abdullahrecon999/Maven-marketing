...
export const InfluencerProfile = () => {
  ...
  const {
    ...
    isError,
    isSuccess,
  } = useQuery("influencer", fetchProfile);
              ...
              <div className="flex flex-col items-center w-full">
                <div className="avatar">
                  ...
                  <div className="w-28 rounded-full">
                    <img src={influencer.data?.photo} />
                  </div>
                </div>
                <p className="text-2xl font-bold">{influencer.data?.name}</p>
                <p className="text-sm text-stone-500">
                  {formatter.format(
                    influencer.data?.socialMediaHandles[0]?.followers
                  )}
                </p>
            ...
            <div className="col-span-3 shadow-xl p-4">
              <div className="flex-col mt-3">
                <div className="flex w-full justify-between pr-4 mb-3">
                  ...
                  <div className="flex gap-1 items-center">
                    ...
                    <a className="link text-[#3f96b6] font-medium link-hover">
                      See more Analytics
                    </a>
                  </div>
                </div>
                <div className="flex gap-3 px-3">
                  <div className="flex-col border rounded-xl p-6 items-center w-full">
                    <p className="text-xs text-[#6c757d] font-medium mb-2">
                      FOLLOWERS
                    </p>
              ...
              <div className="flex-col mt-3">
                ...
                <div className="flex justify-evenly flex-wrap">
                  {influencer.data?.socialMediaHandles.map(
                    (socialMediaHandle, index) => {
                      return (
                        <div className="flex-col shadow-sm hover:shadow-lg m-3 border border-t-8 border-t-pink-600 rounded-xl p-2 items-center">
                          <div className="grid grid-cols-4">
                            <div className="col-span-3 flex-col flex justify-center items-center">
                              ...
                              <p className="text-xs font-bold text-stone-400">
                                {formatter.format(socialMediaHandle.followers)}{" "}
                                FOLLOWERS
                              </p>
                            </div>
