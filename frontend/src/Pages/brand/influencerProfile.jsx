							...
							<div className="col-span-1 h-full flex-col p-4">
								<div className="flex flex-col items-center w-full">
									...
									<div className="flex-col items-start w-full min-h-[250px]">
										...
										<p className="text-stone-500">{influencer.data?.description}</p>
									</div>
									<div className="divider" />
							...
							<div className="col-span-3 shadow-xl p-4">
								...
								<div className="flex-col mt-3">
									...
									<div className="flex justify-evenly flex-wrap">
										...
										{
											influencer.data?.socialMediaHandles.map((socialMediaHandle, index) => {
												return (
													<div className="flex-col shadow-sm hover:shadow-lg m-3 border border-t-8 border-t-pink-600 rounded-xl p-2 items-center">
														<div className="grid grid-cols-4">
															<div className="col-span-3 flex-col flex justify-center items-center">
																...
																<p className="text-sm font-bold">{socialMediaHandle.handle}</p>
																<p className="text-xs font-bold text-stone-400">{formatter.format(socialMediaHandle.followers)} FOLLOWERS</p>
															</div>
